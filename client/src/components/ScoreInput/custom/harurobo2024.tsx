...
export const HinaNingyoIcon = (props: { stat: "none" | "red" | "blue" }) => (
  <HinaNingyoSvg
    style={{
      width: "32px",
      stroke:
        props.stat === "none" ? "rgba(0,0,0,0.6)" : "rgba(255,255,255,0.9)",
  ...
  >
    <Box
      sx={{
        ...
        fontSize: "14px",
        color: props.isPlaced
          ? "rgba(255, 255, 255, 0.8)"
          : "rgba(60, 60, 60, 0.8)",
        backgroundColor: props.isPlaced
          ? props.color
          : "rgba(240, 240, 240, 0.2)",
        borderWidth: "1px",
        borderStyle: props.isPlaced ? "solid" : "dashed",
        borderColor: props.isPlaced
          ? "rgba(255, 255, 255, 0.8)"
          : "rgba(60, 60, 60, 0.5)",
      }}
    >
  ...
  return (
    ...
    >
      <HinaBaseLayer
        label="小台座"
        isPlaced={
          Boolean(props.taskObjects["rule_D"]) ||
          Boolean(props.taskObjects["rule_E"])
        }
        boxHeight={25}
        boxWidth={135}
        color={boxColor}
