...
def write_match_result(payload: dict):
    ...
    try:
        values = [
            ...
            optional(payload, "finalScore.fields.red.tasks.Utsunomiya"),
            optional(payload, "finalScore.fields.red.tasks.Chiba"),
            optional(payload, "finalScore.fields.red.tasks.Saitama"),
            optional(payload, "finalScore.fields.red.tasks.Yokohama"),
            optional(payload, "finalScore.fields.red.tasks.Shibuya"),
            ...
            optional(payload, "finalScore.fields.blue.tasks.Utsunomiya"),
            optional(payload, "finalScore.fields.blue.tasks.Chiba"),
            optional(payload, "finalScore.fields.blue.tasks.Saitama"),
            optional(payload, "finalScore.fields.blue.tasks.Yokohama"),
            optional(payload, "finalScore.fields.blue.tasks.Shibuya"),
