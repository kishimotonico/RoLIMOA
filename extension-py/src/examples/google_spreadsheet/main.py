...
def write_match_result(payload: dict):
    ...
    try:
        values = [
            ...
            optional(payload, "finalScore.fields.red.tasks.beehive_kuma"),
            optional(payload, "finalScore.fields.red.tasks.honney_kuma"),
            optional(payload, "finalScore.fields.red.tasks.beehive_barrel"),
            optional(payload, "finalScore.fields.red.tasks.honney_barrel"),
            ...
            optional(payload, "finalScore.fields.blue.tasks.beehive_kuma"),
            optional(payload, "finalScore.fields.blue.tasks.honney_kuma"),
            optional(payload, "finalScore.fields.blue.tasks.beehive_barrel"),
            optional(payload, "finalScore.fields.blue.tasks.honney_barrel"),
